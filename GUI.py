...
btn1 = Button(window, text='举重', command=lambda :demo.run(1))
btn2 = Button(window, text='俯卧撑', command=lambda :demo.run(2))
btn3 = Button(window, text='马步', command=lambda :demo.run(3))
btn4 = Button(window, text='深蹲', command=lambda :demo.run(4))
