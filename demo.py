...
def run_demo(net, image_provider, height_size, cpu, track, smooth, type):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint-path', type=str, default=r'.\checkpoint_iter_370000.pth',
    ...
    parser.add_argument('--type', type=int, default=1, help='type of the action')
